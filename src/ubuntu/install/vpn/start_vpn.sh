...
function get_set_creds() {
  ...
  echo ${USER} > /home/hostlife-user/vpn_credentials
  echo ${PASS} >> /home/hostlife-user/vpn_credentials
  chown hostlife-user:hostlife-user /home/hostlife-user/vpn_credentials
  cp ${VPN_CONFIG} /home/hostlife-user/vpn.ovpn
  chown hostlife-user:hostlife-user /home/hostlife-user/vpn.ovpn
  sed -i "s#auth-user-pass#auth-user-pass /home/hostlife-user/vpn_credentials#g" /home/hostlife-user/vpn.ovpn
  VPN_CONFIG=/home/hostlife-user/vpn.ovpn
}
